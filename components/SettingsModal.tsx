...
const SettingsModal: React.FC<Props> = ({
  ...
  onAddAccount, onUpdateAccount, onDeleteAccount, aiMessages, playbook
}) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
       <div className="bg-white dark:bg-slate-900 w-full max-w-5xl h-[85vh] md:h-[90vh] rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden border border-slate-200 dark:border-slate-800 animate-in zoom-in-95 duration-200">
          ...
          {/* CONTENT */}
          <div className="flex-1 overflow-y-auto bg-white dark:bg-slate-900 p-6 md:p-12 custom-scrollbar">
             <div className="max-w-3xl">
                {activeTab === 'profile' && (
                    <div className="space-y-6">
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Perfil</h3>
                        <p className="text-slate-500">Configuración de perfil</p>
                    </div>
                )}
                ...
                {activeTab === 'accounts' && (
                    <div className="space-y-6">
                        ...
                        <p className="text-slate-500">Gestiona tus cuentas de trading</p>
                    </div>
                )}

                {activeTab === 'notifications' && (
                    <div className="space-y-6">
                        <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Notificaciones</h3>
                        <p className="text-slate-500">Configuración de notificaciones</p>
                    </div>
                )}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <button 
                                ...
                                className="flex flex-col items-start gap-3 p-4 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-700 transition-all"
                            >
                            ...
                            <button 
                                ...
                                className="md:col-span-2 flex flex-col items-start gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl hover:bg-blue-100 dark:hover:bg-blue-900/30 transition-all"
                            >
                        ...
                        <div className="pt-8 border-t border-slate-200 dark:border-slate-800">
                            {confirmDeleteAll ? (
                                <div className="p-4 bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800 rounded-xl">
                                    <h4 className="font-bold text-rose-700 dark:text-rose-400 mb-2">¿Borrar todo?</h4>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button onClick={() => { onDeleteAll(); setConfirmDeleteAll(false); }} className="px-4 py-2 bg-rose-600 text-white text-xs font-bold rounded-lg">Sí, Borrar</button>
                                    </div>
                                </div>
                            ) : (
                                <button 
                                    onClick={() => setConfirmDeleteAll(true)} 
                                    className="px-4 py-2 bg-rose-100 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400 text-xs font-bold rounded-lg"
                                >
                                    Borrar Todo
                                </button>
                            )}
