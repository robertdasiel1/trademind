...
import { Save, X, Zap, Info, ShieldAlert, Sparkles, Brain, ImageIcon, UploadCloud, Loader2, Calendar, AlertTriangle, Globe, Star, Plus, Clock, Coins, TestTube } from 'lucide-react';
...
const TradeForm: React.FC<Props> = ({ onAdd, goal, trades, isReal = false }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // We use the NET profit calculated in liveEstimate (Gross - Commissions)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden">
        {/* Account Type Indicator Background */}
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-8 relative z-10">
          <div className="space-y-5">
            ...
            {/* Fechas Mejoradas Visualmente con Separación Date/Time */}
