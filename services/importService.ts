...
export const importService = {
  ...
  replaceAllData(importedData: ImportedData): void {
    try {
      ...
      localStorage.setItem('trading_journal_accounts', JSON.stringify(dataToStore.accounts));
      localStorage.setItem('trading_journal_trades', JSON.stringify(dataToStore.trades));
      localStorage.setItem('trading_journal_global_notes', JSON.stringify(dataToStore.notes));
      localStorage.setItem('trading_journal_chat_history', JSON.stringify(dataToStore.aiMessages));
      localStorage.setItem('trading_journal_profile', JSON.stringify(dataToStore.userProfile));
      if (dataToStore.playbook) localStorage.setItem('trading_journal_playbook', JSON.stringify(dataToStore.playbook));
      localStorage.setItem('trading_journal_milestones', JSON.stringify(dataToStore.achievedMilestones));
      localStorage.setItem('trading_journal_active_account', dataToStore.activeAccountId);
    } catch (err) {
